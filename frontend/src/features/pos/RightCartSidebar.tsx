...
export function RightCartSidebar() {
  ...
  return (
    <aside className="w-80 shrink-0 border-l border-slate-200/60 bg-slate-50/50 hidden xl:flex flex-col fixed right-0 top-16 h-[calc(100vh-4rem)] z-20 p-3">
      <div className="flex-1 bg-white rounded-[24px] border border-slate-200/80 shadow-xs flex flex-col overflow-hidden">
        {/* Header Keranjang */}
